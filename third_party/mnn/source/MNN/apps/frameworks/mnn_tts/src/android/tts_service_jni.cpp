...
Java_com_silvercare_aiassistant_tts_TtsService_nativeCreateTTS(JNIEnv *env, jobject thiz, jstring language) {
...
Java_com_silvercare_aiassistant_tts_TtsService_nativeDestroy(JNIEnv *env, jobject thiz, jlong nativePtr) {
...
Java_com_silvercare_aiassistant_tts_TtsService_nativeLoadResourcesFromFile(JNIEnv *env,
                                                                       jobject thiz,
                                                                       jlong nativePtr,
                                                                       jstring resourceDir,
                                                                       jstring modelName,
...
Java_com_silvercare_aiassistant_tts_TtsService_nativeProcess(JNIEnv *env, jobject thiz, jlong nativePtr,
...
JNIEXPORT void JNICALL
Java_com_silvercare_aiassistant_tts_TtsService_nativeSetCurrentIndex(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_silvercare_aiassistant_tts_TtsService_nativeSetSpeakerId(JNIEnv *env, jobject thiz,
                                                                 jlong nativePtr,
                                                                 jstring speakerId) {
    auto ttsService = reinterpret_cast<TaoAvatar::TTSService *>(nativePtr);
